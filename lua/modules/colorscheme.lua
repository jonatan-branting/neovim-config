...
vim.cmd [[ hi! Invisible guifg=NONE guibg=NONE gui=NONE ]]
...
-- highlight("FloatBorder", settings)
-- highlight("PMenu", settings)
-- highlight("FloatBorder", { guibg=bg, guifg=bg})

-- local lighterbg = utils.darken(normal.bg, 1.04, normal.fg)
...
local border_fg = utils.darken("#c0caf5", 0.30)
