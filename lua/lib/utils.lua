...
function M.map_buffer(buffer, range, func, opts)
  local defaults = {
    linewise = false,
  }
  ...
  if start_row == end_row then
    ...
    for i in M.range(2, #lines - 1) do
      func(line_content(i, 1, -1), start_row + i, 1, -1)
    end

    -- end
    func(line_content(#lines, 1, end_col), end_row, 1, end_col)
  end
end
